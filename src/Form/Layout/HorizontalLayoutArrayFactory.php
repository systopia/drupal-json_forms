...
final class HorizontalLayoutArrayFactory extends AbstractLayoutArrayFactory {

  public function supportsDefinition(DefinitionInterface $definition): bool {
    return $definition instanceof LayoutDefinition && 'HorizontalLayout' === $definition->getType();
  }
